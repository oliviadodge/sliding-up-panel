...
/**
 * Created by olivia on 2/16/2016.
 */

public class MySlidingUpPanelLayout extends ViewGroup {

    private static final String TAG = MySlidingUpPanelLayout.class.getSimpleName();
    ...
    private class DragHelperCallback extends MyViewDragHelper.Callback {
        ...
        public void onViewDragStateChanged(int state) {
            if (mDragHelper.getViewDragState() == MyViewDragHelper.STATE_IDLE) {
